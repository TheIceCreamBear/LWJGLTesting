...
public class TargetLeadingEntityRenderer {
	private TargetLeadingEntityShader shader;
	
	public TargetLeadingEntityRenderer(Matrix4f projMat) {
		this.shader = new TargetLeadingEntityShader();
		this.shader.start();
