...
public class TextShader extends ShaderProgram {
	private static final String VERTEX_FILE = "src/com/joseph/test/lwjgl3/renderer/text/vertex.vert";
	private static final String FRAGMENT_FILE = "src/com/joseph/test/lwjgl3/renderer/text/fragment.frag";
