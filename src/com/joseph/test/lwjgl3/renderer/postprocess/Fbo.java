...
public class Fbo {
	// listen, this, is dumb. i get why OGL needs to have constants like this, its not java, enums are hard to have
	// and its just how the C language is made. But this? in Java? When you have ENUMS? this is dumb
	// i dislike this alot
	...
	public void resolveToScreen() {
		...
		GL30.glBlitFramebuffer(0, 0, width, height, 0, 0, GLFWHandler.SCREEN_WIDTH, GLFWHandler.SCREEN_HEIGHT, GL11.GL_COLOR_BUFFER_BIT, GL11.GL_NEAREST);
		this.unbindFrameBuffer();
